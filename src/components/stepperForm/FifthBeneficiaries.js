...
import SixthBeneficiaries from "./SisthBeneficiaries";

const FifthBeneficiaries = ({ countryId, idTypeOptions }) => {
  ...
  const stepValue = ENUM_FORM_STEPS.FIFTH_BENEFICIARIES;
...
export default FifthBeneficiaries;
