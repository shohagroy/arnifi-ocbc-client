...
import FifthBeneficiaries from "./FifthBeneficiaries";

const FourthBeneficiaries = ({ countryId, idTypeOptions }) => {
  ...
  const stepValue = ENUM_FORM_STEPS.FOURTH_BENEFICIARIES;
...
export default FourthBeneficiaries;
