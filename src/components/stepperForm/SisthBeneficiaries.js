...
const SixthBeneficiaries = ({ countryId, idTypeOptions }) => {
  ...
  const stepValue = ENUM_FORM_STEPS.SIXTH_BENEFICIARIES;
...
export default SixthBeneficiaries;
